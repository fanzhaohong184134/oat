...
namespace Wit.Example_BWT901BLE.CalibrationPanels
{
    public class CalibrationPanelBaseForm : Form
    {
        ...
        public CalibrationPanelBaseForm(string title, string intro)
        {
            ...
            var inputGroup = new GroupBox { Text = "输入参数", Dock = DockStyle.Fill };
            ...
            var resultGroup = new GroupBox { Text = "结果与说明", Dock = DockStyle.Fill };
        ...
        protected TextBox AddInputRow(string label, string defaultValue = "")
        {
            ...
            var textBox = new TextBox { Text = defaultValue, Dock = DockStyle.Top };
